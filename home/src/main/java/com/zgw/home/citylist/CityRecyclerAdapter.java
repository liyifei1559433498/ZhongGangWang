...
//                    locationHelper.restart();
                    ...
                    intent.putExtra("city", Constants.currentCity);
                    Constants.city =  Constants.currentCity;
                    Constants.locationCity =  Constants.currentCity;
                    Constants.district =  Constants.currentCity;
                    ((SelectedCityActivity)mContext).setResult(Activity.RESULT_OK, intent);
                    ((SelectedCityActivity)mContext).finish();
                }
            });
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, int position) {
        if (holder instanceof CharacterHolder) {
            ...
            switch (locateState) {
                case LOCATING:
                    ((LocateViewHolder) holder).mTvLocatedCity.setText(Constants.currentCity);
                    break;
                case FAILED:
                    ((LocateViewHolder) holder).mTvLocatedCity.setText(Constants.currentCity);
                    break;
...
//
//    public void setLocation(String locatedCity, LocationHelper locationHelper) {
