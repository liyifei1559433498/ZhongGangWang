...
public class FeedbackGridImageAdapter extends RecyclerView.Adapter<FeedbackGridImageAdapter.ViewHolder> {
    ...
    public FeedbackGridImageAdapter(Context context, onAddPicClickListener mOnAddPicClickListener) {
