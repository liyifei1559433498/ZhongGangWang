...
//                Config.dialog = publicMethod.creageProgressDialog(context);
//            }
...
//                    .withText(shareDesc)
//                    .withTargetUrl(shareLinkUrl);
//            if (image != null) {
//                shareAction = shareAction.withMedia(image); //image为null 微信分享会崩溃需要判断
//            }
    ...
    public static void showMessage(Context context, SHARE_MEDIA platform, String message) {
        ...
        ZGWToast.show(context, mPlatform + message);
    }
