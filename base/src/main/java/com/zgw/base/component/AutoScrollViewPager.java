...
//            scroller = new CustomDurationScroller(getContext(), new QmcInterpolator()); //modify
//            scroller.setScrollDurationFactor(1.5);//add
    ...
    public void setCanScrollable(boolean value) {
