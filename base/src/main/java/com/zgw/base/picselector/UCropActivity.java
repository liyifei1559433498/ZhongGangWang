...
import com.zgw.base.picselector.util.SelectedStateListDrawable;
import com.zgw.base.picselector.view.CropImageView;
...
public class UCropActivity extends AppCompatActivity {
    ...
    /**
     * This method extracts from incoming intent
    ...
    private void setupViews(@NonNull Intent intent) {
        ...
        mToolbarCropDrawable = intent.getIntExtra(UCrop.Options.EXTRA_UCROP_WIDGET_CROP_DRAWABLE, R.drawable.ucrop_ic_cross);
